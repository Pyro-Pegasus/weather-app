...
function changeTheme(d){
  ...
  // if the description includes the word "sunny"
    ...
    $('.current').addClass('clear');
    // if the description includes the word "thunderstorm"
  } else if( d.indexOf('thunderstorm') > 0 ) {
    $('.current').addClass('thunderstorm');
...
function printGraphic(d){
  ...
  // if the description includes the word "thunderstorm"
    ...
    return '<img src="img/svg/Cloud-Lightning.svg" alt="Thunderstorm icon">';
  // if the description includes the word "drizzle"
  } else if( d.indexOf('drizzle') >= 0 ) {
    return '<img src="img/svg/Cloud-Drizzle-Alt.svg" alt="Drizzle icon">';
  // if the description includes the word "snow"
  } else if( d.indexOf('snow') >= 0 ) {
    return '<img src="img/svg/Cloud-Snow-Alt.svg" alt="Snow icon">';
  // if the description includes the word "cloud"
  } else if( d.indexOf('cloud') >= 0 ) {
...
function printTips(d){
  ...
  // if the description includes the word "cloud"
    ...
    return 'Do you see anything in the clouds? Perhaps a bunny?';
  // if the description includes the word "thunderstorm"
  } else if( d.indexOf('thunderstorm') >= 0 ) {
    return 'Wear a raincoat and stay away from the pool';
  // if the description includes the word "sunny"
  } else if( d.indexOf('sunny') >= 0 ) {
...
/* -----------------------------------------------
   ...
   This function will print a <p> with a message.
   (added during class)
